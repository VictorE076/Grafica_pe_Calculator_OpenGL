...
void main(void)
{
    ...
    //  Culoarea finala;
    vec3 emission = vec3(0.0, 0.0, 0.0); // Black Color, initially
    /// 3. Schimbarea culorii finale a cubului in PORTOCALIU, in optiunile: "Fragment" si "Fragment+Mediere_Normale".
    emission = vec3(1.0, 0.5, 0.0); // Orange Color
    ///
