...
{
	glClearColor(1.0f, 1.0f, 1.0f, 0.0f);   //  Culoarea de fond a ecranului (White);
...
void RenderFunction(void)
{
	...
	codCol = 0; // Desenarea liniilor conform instructiunii "switch" din 02_01_Shader.frag;
	...
	//	Desenarea punctelor conform instructiunii "switch" din 02_01_Shader.frag;
	//
	//	Se atribuie alte valoari variabilelor uniforme (colorand diferit cele 6 puncte in functie de "switch"-ul din 02_01_Shader.frag);
	...
	randomized = true; // Punctul suplimentar
