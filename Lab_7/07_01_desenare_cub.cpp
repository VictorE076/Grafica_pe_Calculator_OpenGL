...
/// 1. Observatorul este la inceput in punctul obs = (0, 0, 300) si se uita in jos, inspre punctul de referinta pctRef = (0, 0, -100);
float obsX = 0.0, obsY = 0.0, obsZ = 300.f, /// obs = (0, 0, 300);
	  refX = 0.0f, refY = 0.0f, refZ = -100.f, /// pctRef = (0, 0, -100);
	  vX = 0.0;

//	Elemente pentru matricea de proiectie;
float xMin = -200.f, xMax = 200.f, yMin = -200.f, yMax = 200.f,
...
/// 1. SpecialKeys: 'LEFT', 'RIGHT', 'UP', 'DOWN';
...
void CreateVBO(void)
{
	...
	GLfloat Vertices[] =
	{
		...
		//	Coordonate;					Culori;			
		-50.0f, -50.0f, -50.0f,  1.0f,  0.0f, 1.0f, 0.0f, // indice 0
		 50.0f, -50.0f, -50.0f,  1.0f,  0.0f, 0.9f, 0.0f, // indice 1
		 50.0f,  50.0f, -50.0f,  1.0f,  0.0f, 0.6f, 0.0f, // indice 2
		-50.0f,  50.0f, -50.0f,  1.0f,	0.0f, 0.2f, 0.0f, // indice 3
		//	Varfurile ROSII din planul z = +50;
		//	Coordonate;					Culori;			
		-50.0f, -50.0f,  50.0f,  1.0f,  1.0f, 0.0f, 0.0f, // indice 4
		 50.0f, -50.0f,  50.0f,  1.0f,  0.7f, 0.0f, 0.0f, // indice 5
		 50.0f,  50.0f,  50.0f,  1.0f,  0.5f, 0.0f, 0.0f, // indice 6
		-50.0f,  50.0f,  50.0f,  1.0f,	0.1f, 0.0f, 0.0f, // indice 7
		*/


		/// 1. Desenare TETRAEDRU
		/// Varfurile VERZI din planul z = -50.f (Cele 3 varfuri care alcatuiesc fata triunghiulara "de jos");
		/// Coordonate;					Culori (nuante de VERDE);
		-50.f, -50.f, -50.f, 1.f,		0.f, 1.f, 0.f,	/// indice 0
		50.f, -50.f, -50.f, 1.f,		0.f, 0.9f, 0.f, /// indice 1 
		0.f, 50.f, -50.f, 1.f,			0.f, 0.6f, 0.f, /// indice 2

		/// Varful ROSU din planul z = 50.f (Varful "de sus");
		/// Coordonate;					Culori;
		0.f, 0.f, 50.f, 1.f,			1.f, 0.f, 0.f,	/// indice 3
	};
	...
	GLubyte Indices[] =
	{
		...
		*/
		...
		/// 1. Desenare TETRAEDRU
		0, 1, 2,  /// Triunghi (fata) "de jos" / Contur triunghi (fata) "de jos";
		0, 1, 3,  /// Triunghi lateral;
		1, 2, 3,  /// Triunghi lateral;
		2, 0, 3,  /// Triunghi lateral;
...
void RenderFunction(void)
{
	...
	/// 1. Desenarea fetelor TETRAEDRULUI;
	codCol = 0; // Gradient (culorile din Vertices[] = {...})															//  Culoarea;
	...
	/// 1. Desenarea muchiilor TETRAEDRULUI;
	codCol = 1; // Black															//	Se schimba culoarea;
	glUniform1i(codColLocation, codCol);
	
	glLineWidth(4);

	glDrawElements(GL_LINE_LOOP, 3, GL_UNSIGNED_BYTE, (void*)(0));
	glDrawElements(GL_LINES, 6, GL_UNSIGNED_BYTE, (void*)(12));
