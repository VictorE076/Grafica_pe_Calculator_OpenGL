...
void Initialize(void)
{
	...
	GLfloat angle = PI / 8; /// 22,5 grade (sens trigonometric)
	matrRot = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0.0, 0.0, 1.0)); /// rotatie in jurul axei 'z' (rotatie 2D)
	//	Translatia 1: centrul patratului este translatat in origine;
	matrTransl1 = glm::translate(glm::mat4(1.0f), glm::vec3(-100.f, -100.f, 0.0)); /// originea proiectiei ortogonale
	//	Translatia 2: inversa/opusa translatiei T1;
	matrTransl2 = glm::translate(glm::mat4(1.0f), glm::vec3(100.f, 100.f, 0.0)); /// coordonatele centrului patratului (propriu-zis)
}
