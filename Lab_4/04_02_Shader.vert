...
layout (location = 2) in vec2 texCoord;          /// 3. Se preia din buffer de pe a treia pozitie (2) atributul care contine textura;
...
out vec2 tex_Coord;     /// 3. Transmite textura (de modificat in Shader.frag);
