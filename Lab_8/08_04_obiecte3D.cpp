...
/// 3. Elemente pentru reprezentarea suprafetei unei SFERE si a unui CILINDRU:
...
void SetMVP(void)
{
	...
	/// 3. TRANSLATIE pe axa 'Y':
	projection *= glm::translate(glm::mat4(1.f), glm::vec3(0.f, -110.f, 0.f));
	/// 3. ROTATIE pe axa 'Z', in jurul originii:
	const float angle_180_deg = PI;
	projection *= glm::rotate(glm::mat4(1.f), angle_180_deg, glm::vec3(0.f, 0.f, 1.f));
